<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <a href="{{ route('filament.admin.resources.presensis.index') }}"
            ...
            <h2 class="text-lg font-bold">Total Sudah Presensi Hari Ini, {{ Carbon\Carbon::today()->locale('ID')->translatedFormat('d F Y') }} : {{ $todayCount }}/{{ $allPetugas }} ({{ round($persentase, 2) }}%) Petugas</h2>
